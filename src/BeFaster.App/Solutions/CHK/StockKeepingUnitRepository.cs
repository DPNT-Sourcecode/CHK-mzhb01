    ...
    public class StockKeepingUnitRepository
    {
        ...
        public StockKeepingUnitRepository()
        {
            stockKeepingUnits = new List<StockKeepingUnit>
            {
                ...
                new StockKeepingUnit('E', 40, new DiscountOffer(2, 'B')),
                new StockKeepingUnit('F', 10, new DiscountOffer(3, 'F')),
                ...
                new StockKeepingUnit('N', 40, new DiscountOffer(3, 'M')),
                ...
                new StockKeepingUnit('R', 50, new DiscountOffer(3, 'Q')),
                new StockKeepingUnit('S', 30),
                new StockKeepingUnit('T', 20),
                new StockKeepingUnit('U', 40, new DiscountOffer(4, 'U')),
