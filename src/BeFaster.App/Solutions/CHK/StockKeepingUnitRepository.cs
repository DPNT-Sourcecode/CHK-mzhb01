...
namespace BeFaster.App.Solutions.CHK
{
    public class StockKeepingUnitRepository
    {
        ...
        public StockKeepingUnitRepository()
        {
            ...
            {
                new StockKeepingUnit('A', 50, new Discount(3, 130), new Discount(5, 200)),
                new StockKeepingUnit('B', 30, new Discount(2, 45)),
                new StockKeepingUnit('C', 20),
                new StockKeepingUnit('D', 15),
                new StockKeepingUnit('E', 40, new Discount(2, 'B')),
                new StockKeepingUnit('F', 10, new Discount(3, 'F')),
                new StockKeepingUnit('G', 20),
                new StockKeepingUnit('H', 10, new Discount(5, 45), new Discount(10, 80)),
                new StockKeepingUnit('I', 35),
                new StockKeepingUnit('J', 60),
                new StockKeepingUnit('K', 80, new Discount(2, 150)),
                new StockKeepingUnit('L', 90),
                new StockKeepingUnit('M', 15),
                new StockKeepingUnit('N', 40, new Discount(3, 'M')),
                new StockKeepingUnit('O', 10),
                new StockKeepingUnit('P', 50, new Discount(5, 200)),
                new StockKeepingUnit('Q', 30, new Discount(3, 80)),
                new StockKeepingUnit('R', 50, new Discount(3, 'Q')),
                new StockKeepingUnit('S', 30),
                new StockKeepingUnit('T', 20),
                new StockKeepingUnit('U', 40, new Discount(4, 'U')),
                new StockKeepingUnit('V', 50, new Discount(2, 90), new Discount(3, 130)),
